...
//        System.out.println(solution2(100, 100, new int[]{10,10,10,10,10,10,10,10,10,10}));
        //System.out.println(solution2(5, 5, new int[]{1, 1, 1, 1, 1, 2, 2}));
        //System.out.println(solution2(3, 3, new int[]{1, 1, 1}));//6
        System.out.println(solution2(3, 1, new int[]{1, 1, 1})); //10
    ...
    public static int solution2(int bridge_length, int weight, int[] truck_weights) {
        ...
        for(int num : truck_weights) queue.add(num);

        int SIZE = truck_weights.length < bridge_length ? truck_weights.length : bridge_length;
        while (!queue.isEmpty()){
            int cnt = 0;
            int poll = queue.poll();
    ...
    public static int solution(int bridge_length, int weight, int[] truck_weights) {
        ...
        while(!bridge.isEmpty()){
            ...
            //대기트럭여부
            if(truck_weights.length - index > 0){//다음 트럭 무게
